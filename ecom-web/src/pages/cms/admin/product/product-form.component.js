...
export const ProductForm = ({ defaultData, handleSubmit }) => {
    ...
    const getAllCategory = async () => {
        try {
            ...
            if (response.status) {
                ...
                //  console.log("all_category:",all_cats);
            }
            else {
                toast.error(response.msg)
            }
...
// if(all_brands && all_cats && all_sellers){}
    useEffect(()=>{
        ...
        if(defaultData.title){
            ...
            // }
            // if(prod_data.brand){
            //     let brand = prod_data.brand;
            //     prod_data.brand = {label:brand.title,value: brand._id}
            // }
                ...
                <Form.Group className="row mb-3" controlId="brand">
                    ...
                    {/*    <Select
                        ...
                        <Form.Select
                            ...
                            onChange={formik.handleChange}
                            size="sm"
                            value={formik.values.brand.value}

                        >
                            <option >---Select Any One----</option>
                            {
                                all_brands && all_brands.map((item, key) => (
